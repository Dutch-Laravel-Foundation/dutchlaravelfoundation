...
use App\ResponseCache\InertiaRequestHasher;
...
return [
    ...
    'cache' => [
         ...
         */
        'store' => env('RESPONSE_CACHE_DRIVER', 'response_cache'),
     ...
     */
    'hasher' => InertiaRequestHasher::class,
    ...
    'warm' => [
        ...
        'additional_urls' => [
            '/nieuws?category=Leden',
            '/nieuws?category=Netwerk',
            '/nieuws?category=Inspiratie',
            '/nieuws?category=Bestuur',
            '/kennis?category=Leden',
            '/kennis?category=Netwerk',
            '/kennis?category=Inspiratie',
            '/kennis?category=Tooling',
        ],
    ],
];
