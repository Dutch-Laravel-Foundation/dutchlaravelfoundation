...
updated_at: 1767604693
introduction: |-
  Samenwerken is een leerproces, met uitdagingen, vallen en opstaan leren we het steeds beter. Een goede feedback loop is daarin essentieel. Met dit in gedachte hebben [Flow Concepts](https://flowconcepts.nl/) en [UX](https://ux.nl) de handen in één geslagen en een SaaS app ontwikkelt die de teams beter laat samenwerken.
